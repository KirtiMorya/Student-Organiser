        ...
        <table className="center-table">
          <thead>
            <tr>
              ...
              <th className="border border-black p-2">Credits</th>
          ...
          <tbody>
            {subjects.map((subject, index) => (
              <tr key={index}>
                ...
                <td className="border border-black p-2">{subject.credits}</td>
                <td className="border border-black p-2">{subject.marks}</td>
              </tr>
            ))}
          </tbody>
        </table>
